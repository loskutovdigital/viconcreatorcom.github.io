...
4. Основной адрес уже установлен: https://viconcreator.com. Он закреплён в src/content.py; workflow не подменяет его техническим адресом GitHub Pages. В Settings → Pages → Custom domain используется viconcreator.com.
...
6. Отправьте https://viconcreator.com/sitemap.xml и https://viconcreator.com/sitemap-images.xml. Проверьте главную, EN/NL услуги и одну новую памятку через URL Inspection.
...
python3 src/generate.py --origin https://viconcreator.com --index --portable
...
Обновление домена от 9 сентября 2026: см. DOMAIN-PATCH-20260909.md. Готовая папка dist теперь тоже собрана с основным доменом и разрешённой индексацией.
